...
// ============================================================================
const tags = [
  { id: TAG_IDS.strategic,   label: 'Strategic',   tagType: 'topic', isActive: true },
  { id: TAG_IDS.risk,        label: 'Risk',        tagType: 'topic', isActive: true },
  { id: TAG_IDS.operational, label: 'Operational',  tagType: 'topic', isActive: true },
  { id: TAG_IDS.people,      label: 'People',      tagType: 'topic', isActive: true },
  { id: TAG_IDS.safety,      label: 'Safety',      tagType: 'topic', isActive: true },
];
...
interface TQDef {
  ...
  isRequired: boolean;
  followupTriggers: { condition: string; followupQuestionId: string }[];
}
...
function buildTQs(
  ...
  return questions.map((q, i) => ({
    ...
    followupTriggers: triggers[q.id] || [],
  }));
}
...
// ============================================================================
const templates = [
  { id: TMPL.acqCore,    name: 'Acquiring — Core Questions',             description: DESCRIPTIONS.acqCore,    status: 'published' },
  { id: TMPL.acqCeo,     name: 'Acquiring — CEO/President',              description: DESCRIPTIONS.acqCeo,     status: 'published' },
  { id: TMPL.acqCfo,     name: 'Acquiring — CFO',                        description: DESCRIPTIONS.acqCfo,     status: 'published' },
  { id: TMPL.acqCto,     name: 'Acquiring — CTO/CIO',                    description: DESCRIPTIONS.acqCto,     status: 'published' },
  { id: TMPL.acqTechInf, name: 'Acquiring — Technology & Infrastructure', description: DESCRIPTIONS.acqTechInf, status: 'published' },
  { id: TMPL.acqCommOps, name: 'Acquiring — Commercial Operations',      description: DESCRIPTIONS.acqCommOps, status: 'published' },
  { id: TMPL.acqGovDel,  name: 'Acquiring — Governance & Delivery',      description: DESCRIPTIONS.acqGovDel,  status: 'published' },
  { id: TMPL.acdCore,    name: 'Acquired — Core Questions',              description: DESCRIPTIONS.acdCore,    status: 'published' },
  { id: TMPL.acdCeo,     name: 'Acquired — CEO/Founder',                 description: DESCRIPTIONS.acdCeo,     status: 'published' },
  { id: TMPL.acdCto,     name: 'Acquired — CTO/CIO',                     description: DESCRIPTIONS.acdCto,     status: 'published' },
  { id: TMPL.acdDataProd,name: 'Acquired — Data & Product',              description: DESCRIPTIONS.acdDataProd,status: 'published' },
  { id: TMPL.acdPeople,  name: 'Acquired — CHRO/VP People',              description: DESCRIPTIONS.acdPeople,  status: 'published' },
  { id: TMPL.acdTechInf, name: 'Acquired — Technology & Infrastructure', description: DESCRIPTIONS.acdTechInf, status: 'published' },
  { id: TMPL.acdCommOps, name: 'Acquired — Commercial Operations',       description: DESCRIPTIONS.acdCommOps, status: 'published' },
  { id: TMPL.acdGovDel,  name: 'Acquired — Governance & Delivery',       description: DESCRIPTIONS.acdGovDel,  status: 'published' },
  { id: TMPL.acdClosing, name: 'Acquired — Closing Sequence',            description: DESCRIPTIONS.acdClosing, status: 'published' },
];
...
async function seed() {
  ...
  for (const t of templates) {
    await prisma.interviewTemplate.upsert({
      ...
      create: { id: t.id, name: t.name, description: t.description, status: t.status },
    });
  }
